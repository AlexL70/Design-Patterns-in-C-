...
namespace AdapterDecorator
{
    public class CustomStringBuilder
    {
        ...
        //public CustomStringBuilder Append(char* value, int valueCount)
        //{
        ...
        public CustomStringBuilder Append(StringBuilder value)
        {
            _builder.Append(value);
            return this;
        }
